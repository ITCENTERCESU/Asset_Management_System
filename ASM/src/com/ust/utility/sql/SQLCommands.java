...
public interface SQLCommands {
	...
	String GET_BORROWED_LIST = "SELECT itemId, itemName, status FROM Inventory WHERE itemId IN(SELECT itemId FROM Inventory WHERE status='available' INTERSECT SELECT itemId FROM Borrowed)";
