...
<div class="container">
	...
	<fieldset id="delete-item" class="col-xs-12 col-sm-7">
		...
		<label for="item-id" >Item Id: <input id="item-id" type="text" name="itemId" value="${deleteForm.itemId}" readonly/></label>
		</div>
		
		<div class="form-group">
		<label for="item-name" >Item Name:<input id="item-name" type="text" name="itemName" value="${deleteForm.itemName}" readonly/></label>
		</div>
